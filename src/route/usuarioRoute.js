...
usuarioRouter.route('/signin').get(function(req, res, next) {
    res.setHeader('Content-Type', 'application/json');
    res.json({
        "Title": "Raiz para /UsuariosP/signin"
    });
});
...
usuarioRouter.route('/agregar/usuarioP').post(function(req, res, next) {
    ...
    db.none("insert into usuario (nombre,contraseña,edad,alias,correo,fecharegistro,telefono,activo) values($1,$2,$3,$4,$5,$6,$7,$8)", [req.body.nombre,
            req.body.contrasena,
